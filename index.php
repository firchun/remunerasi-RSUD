...
$routes = [
    ...
    'hitung-jasa-ralan-umum' => './views/hitung_jasa_ralan_umum/index.php',
    'hitung-jasa-dokter-ralan' => './views/hitung_jasa_dokter_ralan/index.php',
    'hitung-jasa-dokter-ralan-umum' => './views/hitung_jasa_dokter_ralan_umum/index.php',
    'hitung-jasa-dokter-ralan/detail' => './views/hitung_jasa_dokter_ralan/detail.php',
    'hitung-jasa-dokter-ralan-umum/detail' => './views/hitung_jasa_dokter_ralan_umum/detail.php',
    'hitung-jasa-dokter-ranap' => './views/hitung_jasa_dokter_ranap/index.php',
    'hitung-jasa-dokter-ranap-umum' => './views/hitung_jasa_dokter_ranap_umum/index.php',
    'hitung-jasa-dokter-ranap/detail' => './views/hitung_jasa_dokter_ranap/detail.php',
    'hitung-jasa-dokter-ranap-umum/detail' => './views/hitung_jasa_dokter_ranap_umum/detail.php',
    'hitung-jasa-ranap' => './views/hitung_jasa_ranap/index.php',
    'hitung-jasa-ranap-umum' => './views/hitung_jasa_ranap_umum/index.php',
