...
<div class="bg-white rounded-2xl border border-green-700 p-3 mb-3">
  ...
  <div class="mt-4 flex gap-2">
    ...
    <button onclick="exportExcelPerPoli()" class="bg-blue-600 hover:bg-blue-700 text-white p-2 rounded-xl transition"><i
...
<script>
  ...
  const tableConfig = {
    ...
    footerCallback: function (row, data, start, end, display) {
      ...
      $(api.column(16).footer()).html(fmt(sumData('jasa_apoteker')));
      $(api.column(17).footer()).html(fmt(sumData('jasa_non_apoteker')));
      $(api.column(18).footer()).html(fmt(sumData('total_dokter_lab')));
      $(api.column(19).footer()).html(fmt(sumData('total_petugas_lab')));
      $(api.column(20).footer()).html(fmt(sumData('total_menejemen_lab')));
      $(api.column(21).footer()).html(fmt(sumData('jasa_lab')));
      $(api.column(22).footer()).html(fmt(sumData('total_dokter_radiologi')));
      $(api.column(23).footer()).html(fmt(sumData('total_petugas_radiologi')));
      $(api.column(24).footer()).html(fmt(sumData('total_menejemen_radiologi')));
      $(api.column(25).footer()).html(fmt(sumData('jasa_radiologi')));
      $(api.column(26).footer()).html(fmt(sumData('total_jasa')));
      $(api.column(3).footer()).html(fmt(sumData('total_bpjs')));
      $(api.column(4).footer()).html(fmt(sumData('kolom_44')));

      $(api.column(27).footer()).html(pct(st2('total_tindakan_dr'), sj2));
      $(api.column(28).footer()).html(fmt(sumData('jumlah_dpjp')));
      $(api.column(29).footer()).html(pct(st2('total_tindakan_pr'), sj2));
      $(api.column(30).footer()).html(fmt(sumData('jumlah_perawat')));
      $(api.column(31).footer()).html(pct(st2('jasa_apoteker'), sj2));
      $(api.column(32).footer()).html(fmt(sumData('jumlah_farmasi')));
      $(api.column(33).footer()).html(pct(st2('total_dokter_lab'), sj2));
      $(api.column(34).footer()).html(fmt(sumData('jumlah_dokter_lab')));
      $(api.column(35).footer()).html(pct(st2('total_petugas_lab'), sj2));
      $(api.column(36).footer()).html(fmt(sumData('jumlah_analis_lab')));
      $(api.column(37).footer()).html(pct(st2('total_dokter_radiologi'), sj2));
      $(api.column(38).footer()).html(fmt(sumData('jumlah_dokter_radiologi')));
      $(api.column(39).footer()).html(pct(st2('total_petugas_radiologi'), sj2));
      $(api.column(40).footer()).html(fmt(sumData('jumlah_radiografer')));
      $(api.column(41).footer()).html(pct(st2('total_non_medis'), sj2));
      $(api.column(42).footer()).html(fmt(sumData('jumlah_non_medis')));
    }
  };
  ...
  function exportExcelPerPoli() {
    ...
    window.open(window.BASE_URL + '/api/export_hitung_jasa_ralan.php?' + $.param(params), '_blank');
  }
</script>
