...
$(document).ready(function() {
  ...
  table = $('#tabelTindakan').DataTable({
    ...
    footerCallback: function(row, data, start, end, display) {
      ...
      $(api.column(26).footer()).html(sumData('jumlah_resep_non_racikan'));
      $(api.column(28).footer()).html(sumData('jumlah_resep_operasi'));
      $(api.column(30).footer()).html(formatIDR(sumData('jasa_farmasi')));
      $(api.column(31).footer()).html(formatIDR(sumData('total_obat')));

      // LAB
      $(api.column(32).footer()).html(formatIDR(sumData('total_material_lab')));
      $(api.column(33).footer()).html(formatIDR(sumData('total_dokter_lab')));
      $(api.column(34).footer()).html(formatIDR(sumData('total_petugas_lab')));
      $(api.column(35).footer()).html(formatIDR(sumData('total_menejemen_lab')));
      $(api.column(36).footer()).html(formatIDR(sumData('total_lab')));

      // RADIOLOGI
      $(api.column(38).footer()).html(formatIDR(sumData('total_material_radiologi')));
      $(api.column(39).footer()).html(formatIDR(sumData('total_dokter_radiologi')));
      $(api.column(40).footer()).html(formatIDR(sumData('total_petugas_radiologi')));
      $(api.column(41).footer()).html(formatIDR(sumData('total_menejemen_radiologi')));
      $(api.column(42).footer()).html(formatIDR(sumData('total_radiologi')));

      // TOTAL AKHIR
      $(api.column(43).footer()).html(formatIDR(sumTotalBayar()));
      $(api.column(44).footer()).html(formatIDR(sumData('total_bpjs')));
    }
  });
});
